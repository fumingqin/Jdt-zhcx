...
<script>
	...
	export default {
		...
		onLoad(param){
			...
			that.routeorigin=param.routeorigin;
			that.routedestination=param.routedestination;
			//获取站点列表
				...
				uni.request({
					...
					success: (res) => {
						...
						if (res.data.data.length != 0) {
								var cityNameArray = {
									SiteName : res.data.data[0].starSiteArr.SiteName,
								}
