<template>
	<view>
		<!-- 顶部文本 -->
		<view>
			<text class="if_topText">因微信满一年订单保护机制，押金无法原路退回，需提供姓名及身份证，进行人工手动退款，确认申请退款点击退押金按钮</text>
		</view>
		
		<!-- 输入银行卡号 -->
		<view class="if_cardNumber">
			<text class="cn_text">卡号</text>
			<input name="nickNumber" class="cn_card" placeholder-style="#AAAAAA"  type="number" placeholder="请输入卡号"  maxlength="19" />
		</view>
