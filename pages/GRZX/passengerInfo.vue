<template>
	<view class="content">
		<view class="passengerList">
			<view class="boxClass" v-if="submitType == 1 || submitType == 2" v-for="(item, index) in passengerList" :key="index"
			 @click="choosePassenger(item)">
				<!--非个人中心页面进入 -->
		...
		<view v-if="submitType == 1 || submitType == 2" class="btnBox">
			<!--非个人中心页面进入 -->
